...
function map() {
	...
	icon: image,
	 title: 'Mi ubicación',
	 infoWindow: {
	 content: '<div id="mi_maker">' +
	 '<img width="200" height="200" class="img-responsive" src="img/mi_ubicacion.jpg"/>' +
	 '<h4 class="mi_map_parrafo">Hola me puedes hallar aqui...</h4>'+
	 '<h4 class="mi_map_parrafo">Santa Rosa 231-Segui-Entre Rios.</h4>'+
 	'</div>'
	 }
    });
}
