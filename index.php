...
<head>
    ...
    <meta name="keywords" content="ivan sergio lopez">
...
<?php include("controllers/gestiona.php") ?>


<?php include("views/cabecera.php"); ?>

<?php include("views/sobreMi.php") ?>

<?php include("views/servicios.php") ?>

<?php include("views/experiencia.php") ?>

<?php include("views/showcase.php"); ?>

<?php include("views/educacion.php") ?>

<?php include("views/habilidades.php") ?>

<?php include("views/contactar.php") ?>
